...
class TestTransformer(unittest.TestCase):
    def setUp(self):
        ...
        with open("../../resources/transformer/KREFTREG_DS.json") as json_file:
            self.dataset = json.load(json_file)
        with open("../../resources/transformer/KREFTREG_DS_expected.json") as expected_json_file:
            self.expected_dataset = json.load(expected_json_file)
